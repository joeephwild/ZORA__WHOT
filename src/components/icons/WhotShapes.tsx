...
const Circle = (props: SVGProps<SVGSVGElement> & {small?: boolean}) => (
    <svg viewBox="0 0 100 100" {...props}><circle cx="50" cy="50" r={props.small ? 50: 45} fill="currentColor" /></svg>
);

const Triangle = (props: SVGProps<SVGSVGElement>  & {small?: boolean}) => (
    <svg viewBox="0 0 100 100" {...props}><path d="M50 5 L95 95 L5 95 Z" fill="currentColor" /></svg>
);

const Cross = (props: SVGProps<SVGSVGElement>  & {small?: boolean}) => (
...
const Square = (props: SVGProps<SVGSVGElement>  & {small?: boolean}) => (
    <svg viewBox="0 0 100 100" {...props}><rect x="10" y="10" width="80" height="80" fill="currentColor" /></svg>
);

const Star = (props: SVGProps<SVGSVGElement>  & {small?: boolean}) => (
